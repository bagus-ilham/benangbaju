  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-1/2 relative bg-brand-black overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-px h-full bg-gradient-to-b from-transparent via-brand-accent/40 to-transparent" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          <Link
            href="/"
            className="font-heading text-sm font-bold tracking-[0.25em] text-white uppercase hover:text-brand-accent-light transition-colors duration-300"
          >
            BENANGBAJU
          </Link>
          ...
          <div className="space-y-6 max-w-md">
            <div className="stitch-divider">
              <span className="text-[10px] uppercase tracking-[0.25em] font-heading font-medium text-brand-accent-light">
