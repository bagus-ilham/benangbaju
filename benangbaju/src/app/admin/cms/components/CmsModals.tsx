...
import { Button, Input, Select, Switch, Textarea, Modal } from '@/shared/components'
...
export function RedirectFormModal({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={editingRedirect ? 'Ubah Aturan Pengalihan' : 'Tambah Aturan Pengalihan'}
      size="md"
    >
...
export function LandingPageFormModal({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={editingPage ? 'Ubah Landing Page' : 'Buat Landing Page Baru'}
      size="lg"
    >
