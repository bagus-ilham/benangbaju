...
export function RedirectFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/40 backdrop-blur-xs font-sans text-xs">
      <div className="bg-brand-cream border border-neutral-200 w-full max-w-md p-6 sm:p-8 space-y-6">
...
export function LandingPageFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/40 backdrop-blur-xs font-sans text-xs">
      <div className="bg-brand-cream border border-neutral-200 w-full max-w-lg p-6 sm:p-8 space-y-6">
        <div className="flex justify-between items-center border-b border-neutral-100 pb-3">
          <h3 className="font-sans text-lg font-bold text-brand-plum">
