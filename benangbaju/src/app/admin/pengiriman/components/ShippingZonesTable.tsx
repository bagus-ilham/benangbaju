      ...
      {zones.map((zone) => (
        ...
        >
          ...
          <div className="pt-4 border-t border-neutral-100 flex justify-end space-x-2">
            <Button onClick={() => onEdit(zone)} variant="outline" className="text-[10px] py-1.5 px-3 font-bold uppercase border-neutral-200">
              <Edit size={11} className="mr-1" /> Edit
            </Button>
            <Button onClick={() => onDelete(zone.id, zone.name)} variant="outline" className="text-[10px] py-1.5 px-3 font-bold uppercase border-red-200 text-red-500 hover:bg-red-50">
