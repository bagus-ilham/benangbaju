          ...
          {rates.map((rate) => (
            <tr key={rate.id} className="hover:bg-neutral-50/30">
              ...
              <td className="py-4 px-6 text-right space-x-1.5">
                <button onClick={() => onEdit(rate)} className="text-neutral-500 hover:text-neutral-800 p-1.5 inline-block border border-neutral-200">
                  <Edit size={12} />
                </button>
                <button onClick={() => onDelete(rate.id, rate.courier_name)} className="text-red-500 hover:text-red-700 p-1.5 inline-block border border-red-100 hover:bg-red-50">
                  <Trash2 size={12} />
                </button>
              </td>
            </tr>
