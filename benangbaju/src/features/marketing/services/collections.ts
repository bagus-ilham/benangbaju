...
import { CollectionService } from '@/features/marketing/application/collection.service'
import * as types from '@/features/marketing/domain/collection.types'

export type { AdminCollectionItem, Collection } from '@/features/marketing/domain/collection.types'
...
export async function adminUpdateCollection(
  ...
  return new CollectionService(supabase).adminUpdateCollection(
    collectionId,
    collectionData,
    productIds
  )
