...
import { CmsService } from '@/features/marketing/application/cms.service'
import * as types from '@/features/marketing/domain/cms.types'

export type { RedirectRule, LandingPage } from '@/features/marketing/domain/cms.types'
...
export async function adminCreateRedirect(
  ...
  redirect: Omit<types.RedirectRule, 'id' | 'created_at'>
) {
...
export async function adminUpdateRedirect(
  supabase: SupabaseClient<Database>,
  redirectId: string,
  redirect: Partial<Omit<types.RedirectRule, 'id' | 'created_at'>>
) {
...
export async function adminCreateLandingPage(
  supabase: SupabaseClient<Database>,
  landingPage: Omit<types.LandingPage, 'id' | 'created_at' | 'updated_at'>
) {
...
export async function adminUpdateLandingPage(
  ...
  landingPage: Partial<Omit<types.LandingPage, 'id' | 'created_at' | 'updated_at'>>
) {
