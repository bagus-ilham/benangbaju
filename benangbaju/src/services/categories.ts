...
import { CategoryService } from "@/modules/category/application/category.service";
import * as types from "@/modules/category/domain/category.types";

export type { Category } from "@/modules/category/domain/category.types";
