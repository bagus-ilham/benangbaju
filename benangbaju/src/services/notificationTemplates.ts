...
import { NotificationTemplateService } from "@/modules/notificationTemplate/application/notificationTemplate.service";
import * as types from "@/modules/notificationTemplate/domain/notificationTemplate.types";

export type { NotificationTemplate } from "@/modules/notificationTemplate/domain/notificationTemplate.types";
