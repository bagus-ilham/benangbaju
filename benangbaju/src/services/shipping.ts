...
import * as types from "@/modules/shipping/domain/shipping.types";

export type { UserAddress, District, ShippingOption, ShippingCalculationResult, ShippingZone, ShippingRate } from "@/modules/shipping/domain/shipping.types";
