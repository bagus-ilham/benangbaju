...
export class ShippingService {
    ...
    async updateUserAddress(addressId: string, userId: string, address: Partial<Omit<UserAddress, 'id' | 'user_id' | 'created_at'>>) {
    ...
    async adminUpdateShippingZone(zoneId: string, zone: Partial<Omit<ShippingZone, 'id' | 'shipping_zone_coverage'>>, provinces?: string[]) {
    ...
    async adminUpdateShippingRate(rateId: string, rate: Partial<Omit<ShippingRate, 'id' | 'shipping_zones'>>) {
