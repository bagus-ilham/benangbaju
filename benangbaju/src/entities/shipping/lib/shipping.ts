...
export type {
  ...
  ShippingZone,
  ShippingRate,
} from '@/features/core/domain/shipping.types'
...
export async function addUserAddress(
  ...
  address: Omit<types.UserAddress, 'id' | 'created_at'>
) {
...
export async function updateUserAddress(
  ...
  addressId: string,
  userId: string,
  address: Partial<Omit<types.UserAddress, 'id' | 'user_id' | 'created_at'>>
) {
...
export async function adminCreateShippingZone(
  supabase: SupabaseClient<Database>,
  zone: Omit<types.ShippingZone, 'id' | 'shipping_zone_coverage'>,
  provinces: string[]
) {
...
export async function adminUpdateShippingZone(
  supabase: SupabaseClient<Database>,
  zoneId: string,
  zone: Partial<Omit<types.ShippingZone, 'id' | 'shipping_zone_coverage'>>,
  provinces?: string[]
) {
...
export async function adminCreateShippingRate(
  supabase: SupabaseClient<Database>,
  rate: Omit<types.ShippingRate, 'id' | 'shipping_zones'>
) {
...
export async function adminUpdateShippingRate(
  supabase: SupabaseClient<Database>,
  rateId: string,
  rate: Partial<Omit<types.ShippingRate, 'id' | 'shipping_zones'>>
) {
